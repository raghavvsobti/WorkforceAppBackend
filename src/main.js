...
var fallback_filter_1 = require("./filters/fallback.filter");
var http_filter_1 = require("./filters/http.filter");
                    ...
                    app.useGlobalPipes(new common_1.ValidationPipe({
                        ...
                        exceptionFactory: function (errors) {
                            var messages = errors.map(function (error) {
                                return "".concat(error.property, " has wrong value ").concat(error.value, ", ").concat(Object.values(error.constraints).join(","));
                            });
